...
window.HTMLBOOK_DRIVE_CONFIG = {
  ...
  // 로그인 권한 범위.
  //   "full"     — 드라이브 읽기+쓰기. 파일 탐색기(트리)·편집·자동 저장이 모두 동작. (개인용 권장)
  //   "readonly" — 드라이브 전체 읽기. 탐색·열람만 가능, 편집 불가.
  //   "file"     — Picker 로 고른 파일만 접근(최소 권한). 탐색기·편집 불가.
  ...
  //  테스트 상태의 동의는 7일마다 만료될 수 있어, 일주일에 한 번쯤 동의 화면이 다시 뜹니다.)
  SCOPE_MODE: "full",
};
